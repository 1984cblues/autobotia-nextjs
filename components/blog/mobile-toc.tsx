...
import { Drawer, DrawerTrigger, DrawerContent, DrawerHeader, DrawerBody, DrawerFooter } from "@/components/ui-blog/drawer";
  ...
  return (
    <Drawer>
      ...
      <DrawerContent className="lg:hidden">
        <DrawerHeader>
          <h3 className="font-semibold text-foreground">Sumário</h3>
        </DrawerHeader>
